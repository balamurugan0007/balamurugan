        ...
        <div className="flex flex-wrap items-top mb-6">
          <div className="w-full lg:w-4/12 px-4 ml-auto">
            ...
            <ul className="list-unstyled">
              <li>
                <a className="text-blueGray-600 hover:text-blueGray-800 font-inter font-semibold block pb-2 text-sm" target='_blank' href="/">Portfolio</a>
              </li>
              <li>
                <a className="text-blueGray-600 hover:text-blueGray-800 font-inter font-semibold block pb-2 text-sm" target='_blank' href="https://medium.com/@balamurugan.k.02437">Blog</a>
              </li>
              <li>
          ...
          <div className="w-full lg:w-4/12 px-4">
            ...
            <ul className="list-unstyled">
              <li>
                <a className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" target='_blank' href="">License</a>
              </li>
              <li>
                <a className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" target='_blank' href="">Terms &amp; Conditions</a>
              </li>
              <li>
                <a className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" target='_blank' href="">Privacy Policy</a>
              </li>
              <li>
                <a className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm" target='_blank' href="">Contact Us</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2023</span><a target='_blank' href="/" className="text-blueGray-500 hover:text-gray-800" >by </a>
          <a target='_blank' href="/" className="text-blueGray-500 hover:text-blueGray-800"> Balamurugan</a>.
        </div>
      </div>
    </div>
  </div>
